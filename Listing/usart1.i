...
#line 12 "..\\BSP\\USART1.c"
#line 13 "..\\BSP\\USART1.c"
uint8_t ReadBuffer[23];
...
void DMA_Usart1_Config(void)
{
    ...
    DMA_InitStructure.DMA_PeripheralBaseAddr = (u32)(&(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800))->DR));	   
	...
	USART_DMACmd(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800)),((uint16_t)0x0040),ENABLE);
