...
uint64_t time_nowUs(void)
{
    return time.msPeriod * (uint64_t)1000 + (((SysTick_Type *) ((0xE000E000) + 0x0010))->LOAD - ((SysTick_Type *) ((0xE000E000) + 0x0010))->VAL) / time.ticksPerUs;
}


uint32_t time_nowMs(void)
{
    return time.msPeriod + (((SysTick_Type *) ((0xE000E000) + 0x0010))->LOAD - ((SysTick_Type *) ((0xE000E000) + 0x0010))->VAL) / time.ticksPerMs;
}
