...
void USART1_IRQHandler(void)
{
	...
	{ 	
	    c=((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800))->DR;
	  	printf("%c",c);    
	} 
...
{	
	...
	DMA_ITConfig(((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x0058)),((uint32_t)0x00000002),DISABLE);
	now_time = time_nowMs();
	Dlt_Tim = now_time - Pre_Tim;
	Pre_Tim = now_time;
	Pre_Angle=Att_Angle;

   if(DMA_GetFlagStatus(((uint32_t)0x00020000))==SET) 
  {  
		for(i=0;i<(23-11);i++)
		{
...
L1:		
		...
		DMA_ClearFlag(((uint32_t)0x00020000));


		DMA_ITConfig(((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x0058)),((uint32_t)0x00000002),ENABLE);
...
{	
	static u8 ms1_cnt=0;
	if(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0000))->SR & ((uint16_t)0x0001))		
	{     
