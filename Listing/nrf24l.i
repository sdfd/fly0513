...
u8  TX_ADDRESS[5]= {0xE1,0xE2,0xE3,0xE4,0xE5};	
u8  RX_ADDRESS[5]= {0xE1,0xE2,0xE3,0xE4,0xE5};	
...
{	
	...
	NRF_Write_Buf(0x20 + 0x10, TX_ADDRESS, 5); 
	NRF_Write_Buf(0xA0, tx_buf, len); 			 
...
{
	GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1C00)),((uint16_t)0x0001));
	NRF_Write_Buf(0x20+0x0A,RX_ADDRESS,5);	
	NRF_Write_Buf(0x20+0x10,TX_ADDRESS,5); 		
	NRF_Write_Reg(0x20+0x01,0x01); 													
	NRF_Write_Reg(0x20+0x02,0x01);											
	NRF_Write_Reg(0x20+0x04,0x05);											
	...
	{
		NRF_Write_Reg(0xE1,0xff);
		NRF_Write_Reg(0xE2,0xff);
		NRF_Write_Reg(0x20 + 0x00, 0x0f);   		 
		
		Spi_RW(0x50);
		Spi_RW(0x73);
		NRF_Write_Reg(0x20+0x1c,0x01);
		NRF_Write_Reg(0x20+0x1d,0x06);
	}
	else								
	{
		NRF_Write_Reg(0x20 + 0x00, 0x0e);   		 
