...
static void PWM_GPIO_Init()
{
	 ...
	 GPIO_InitPWM.GPIO_Pin = ((uint16_t)0x0040) | ((uint16_t)0x0080) | ((uint16_t)0x0100) | ((uint16_t)0x0200);
	 GPIO_InitPWM.GPIO_Speed = GPIO_Speed_50MHz;
	 GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000)),&GPIO_InitPWM);
...
static void PWM_Mode_Init()
{
	...
	TIM_TimeBaseInitPWM.TIM_ClockDivision = ((uint16_t)0x0000);
	TIM_TimeBaseInitPWM.TIM_CounterMode = ((uint16_t)0x0000);
	TIM_TimeBaseInitPWM.TIM_Period = 40000; 
	TIM_TimeBaseInitPWM.TIM_Prescaler = 36; 
	
	TIM_TimeBaseInit(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0400)),&TIM_TimeBaseInitPWM);
	
	TIM_OCInitPWM.TIM_OCMode = ((uint16_t)0x0060) ;
	TIM_OCInitPWM.TIM_OCPolarity = ((uint16_t)0x0000);
	TIM_OCInitPWM.TIM_OutputState = ((uint16_t)0x0001) ;
	TIM_OCInitPWM.TIM_Pulse = CCR1_Val;
	TIM_OC1Init(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0400)),&TIM_OCInitPWM);
	TIM_OC1PolarityConfig(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0400)),ENABLE);
	
	TIM_OCInitPWM.TIM_OutputState = ((uint16_t)0x0001) ;
	TIM_OCInitPWM.TIM_Pulse = CCR2_Val;
	TIM_OC2Init(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0400)),&TIM_OCInitPWM);
	TIM_OC2PolarityConfig(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0400)),ENABLE);
	
	TIM_OCInitPWM.TIM_OutputState = ((uint16_t)0x0001) ;
	TIM_OCInitPWM.TIM_Pulse = CCR3_Val;
	TIM_OC3Init(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0400)),&TIM_OCInitPWM);
	TIM_OC3PolarityConfig(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0400)),ENABLE);
	
	TIM_OCInitPWM.TIM_OutputState = ((uint16_t)0x0001) ;
	TIM_OCInitPWM.TIM_Pulse = CCR4_Val;
	TIM_OC4Init(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0400)),&TIM_OCInitPWM);
	TIM_OC4PolarityConfig(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0400)),ENABLE);	
...
void motor_Control(int16_t CCR_Val1,int16_t CCR_Val2,int16_t CCR_Val3,int16_t CCR_Val4)
{
	if(CCR_Val1>4000) CCR_Val1=4000;
	if(CCR_Val2>4000) CCR_Val2=4000;
	if(CCR_Val3>4000) CCR_Val3=4000;
	if(CCR_Val4>4000) CCR_Val4=4000;
	
	if(CCR_Val1<2000) CCR_Val1=2000;
	if(CCR_Val2<2000) CCR_Val2=2000;
	if(CCR_Val3<2000) CCR_Val3=2000;
	if(CCR_Val4<2000) CCR_Val4=2000;
	
	((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0400))->CCR1 = CCR_Val1;
	((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0400))->CCR2 = CCR_Val2;
	((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0400))->CCR3 = CCR_Val3;
	((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0400))->CCR4 = CCR_Val4;
}
