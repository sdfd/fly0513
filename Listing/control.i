...
{
	T_float_angle angle;
	angle.rol = att_in->rol - (rc_in->ROLL-3000)/12;
	angle.pit = att_in->pit - (rc_in->PITCH-3000)/12;
	...
	if(rc_in->YAW<2800||rc_in->YAW>3200)
	{gyr_in->Z=gyr_in->Z+(rc_in->YAW-3000)*2;}
	yaw_p+=gyr_in->Z*0.0609756f*0.002f;
	if(yaw_p>20)
		yaw_p=20;
	if(yaw_p<-20)
		yaw_p=-20;
	...
	if(rc_in->THROTTLE>2200&&armed)
	{
		Moto_PWM_1 = rc_in->THROTTLE - 2200 - PID_ROL.OUT + PID_PIT.OUT + PID_YAW.OUT;
		Moto_PWM_2 = rc_in->THROTTLE - 2200 - PID_ROL.OUT - PID_PIT.OUT - PID_YAW.OUT;
		Moto_PWM_3 = rc_in->THROTTLE - 2200 + PID_ROL.OUT - PID_PIT.OUT + PID_YAW.OUT;
		Moto_PWM_4 = rc_in->THROTTLE - 2200 + PID_ROL.OUT + PID_PIT.OUT - PID_YAW.OUT;
	}
	else
	{
		Moto_PWM_1 = 0;
